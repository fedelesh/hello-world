...
btn = Button(root,
             text="Dependence of the threshold voltage on the concentration of impurities in the substrate",
             width=110,height=5,
             bg="white",fg="black")
...
btn1 = Button(root,
             text="Dependence of the current in the channel on the ratio of the width of the channel to its length",
             width=110,height=5,
             bg="white",fg="black")
...
btn2 = Button(root,
             text="Dependence of the threshold voltage on the thickness of the screw dielectric",
             width=110,height=5,
             bg="white",fg="black")
